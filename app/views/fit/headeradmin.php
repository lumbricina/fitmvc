...
<head>
    ...
    <link href="<?=ASSETS?>fit/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="sidebar-brand d-flex align-items-center justify-content-center" style="color: var(--primary); font-size:24px; font-weight: bolder;">FIT</div>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo implode($_SESSION['nama']); ?></span>
                                <img class="img-profile rounded-circle"
                                    src="<?=ASSETS?>fit/img/undraw_profile.svg">
                            </a>
